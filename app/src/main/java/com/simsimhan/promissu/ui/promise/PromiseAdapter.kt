...
//        private val items: MutableList<PromiseResponse>,
...
//    }
//
//    fun reset(onNext: List<PromiseResponse>) {
//        items.clear()
//        items.addAll(onNext)
...
//
//        fun bind(_viewModel: PromiseViewModel, _response: PromiseResponse, _isPastPromise: Boolean, _lifecycleOwner: LifecycleOwner, _listener: PromiseItemEventListener) {
//            itemBinding.apply {
//                response = _response
